...
class SettingsViewSet(GenericViewSet):
    ...
    def get_data(self, user):
        base_rate = models.RateForDelivery.objects.first()
    ...
    def patch(self, request, *args, **kwargs):
        ...
        if base_rate:
            obj_base_rate = models.RateForDelivery.objects.get(id=base_rate.get("id"))
            serializer = RateForDeliverySerializer(obj_base_rate, data=base_rate)
